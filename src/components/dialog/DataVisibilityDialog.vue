  ...
  <v-dialog max-width="40rem">
    <v-card>
      ...
      <v-card-text>
        ...
        <div v-for="(expr, index) in customExpressions" :key="index" class="d-flex align-center mb-2">
          <v-text-field
      ...
      <v-card-actions>
        ...
        <v-btn color="primary" @click="updateDataVisibility" :loading="loading">保存</v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
